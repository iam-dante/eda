...
export default function Chat({ chatId }: { chatId: string }) {
  ...
  return (
    // <div className="flex flex-col items-center h-screen px-[12%] bg-red-500 md:ml-64 py-6 overflow-y-auto ">
    ...
    <div className="h-screen md:ml-64 ">
      <div className="h-[90%] overflow-y-auto px-40 py-6">
